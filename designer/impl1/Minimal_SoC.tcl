...
set_defvar "IDE_DESIGNERVIEW_ROOTDIR" {C:\Users\micha\Documents\Clyde\designer}
set_defvar "IDE_DESIGNERVIEW_LASTREV" "1"


# import of input files
import_source  \
-format "edif" -edif_flavor "GENERIC" -netlist_naming "VERILOG" {../../synthesis/Minimal_SoC.edn} -merge_physical "yes" -merge_timing "yes"
compile
